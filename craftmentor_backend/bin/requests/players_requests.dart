...
class PlayerRequests {
  ...
  void _init() {
    _getAllPlayers();
    _registerNewPlayer();
    _verifyIfPlayerExists();
    _updatePlayerPontuation();
  }
...
''',
        ...
        return Response.badRequest(
          body: jsonEncode(
            {
              'error':
                  'Não foi possível atualizar pontuação do jogador jogador.',
              'serverMessage': e.toString(),
            },
          ),
        );
